...
export interface BuildingConfig {
  ...
  /** Silhouette family (§ visual identity): 'round' factions build with curved/domed forms, 'angular' factions with flat panels and hard edges — consistent across every building AND unit of that faction, so faction identity reads beyond just color. */
  shapeFamily: 'round' | 'angular';
